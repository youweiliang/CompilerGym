...
http_archive(
    name = "programl",
    sha256 = "6bd325fb2ed78eab5e2ad9f0e0f9a9851e42f4147a316071b8e3503800b98507",
    strip_prefix = "ProGraML-0.3.2.1",
    urls = ["https://github.com/youweiliang/ProGraML/archive/refs/tags/v0.3.2.1.tar.gz"],
)
